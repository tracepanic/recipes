...
export default function Recipes_Window({ id, children }: CategoryWindowProps) {
    ...
    return (
        <div className="flex font-mono flex-col items-center">
            ...
            {openModel && (
                <div className="absolute  gap-y-2 flex flex-col top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-white/10 z-1000 p-12 rounded-xl backdrop-blur-3xl border-blue-300 shadow-2xl shadow-cyan-500/50 border-solid border-[0.2px] ">
